      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-slate-800/80">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Diseñado para ciudadanos, periodistas de datos, investigadores y concejales.
            </p>
            <div className="bg-slate-800/80 p-3 rounded-xl border border-slate-700/60 space-y-1 text-xs">
              <span className="text-slate-300 font-semibold block">⚠️ Estado del Proyecto</span>
              <p className="text-slate-400 text-[11px]">
                Prototipo funcional con dataset estructurado para validación comunitaria.
              </p>
            </div>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          <p>© {new Date().getFullYear()} INFORMAR Argentina. Desarrollado con vocación cívica y datos abiertos.</p>
